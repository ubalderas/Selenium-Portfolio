...
Suite Start
    Open Browser to ${w3SchoolsUrl} using firefox
    w3Schools Page Should be Open
...
Scroll Element into View
    ...
    ...     ELSE IF     '${locatorType}'=='XPATH'     Execute Javascript      document.evaluate("${locator}", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.scrollIntoView()
